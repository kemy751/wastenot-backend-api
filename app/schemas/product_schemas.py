...
class ListingSchema(Schema):
    ...
    # Using Decimal instead of Float avoids financial binary rounding errors
    ...
    interest_count = fields.Int(dump_only=True)
...
class ListingInterestSchema(Schema):
    ...
    # Contextual fields populated during serializations/joins
